      ...
      <section className='z-0 w-[100vw] flex flex-col items-center justify-center pb-50'>
        <div className='max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.4} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 rounded-t-3xl border-[#1c398e]/25 border-4 border-solid'>
            ...
            <FadeContent blur delay={0.6} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 2: Using iLoader to install SideStore</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 3: Downloading the IPA</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 4: Installing Pocket Poster</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 5: Getting your App Hash</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 6: Importing wallpapers</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 7: Applying wallpapers</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 rounded-b-3xl border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Step 7: Getting your wallpaper</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 rounded-t-3xl border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>I'm having issues with SideStore.</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>I can't get my app hash.</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>"Failed to fetch/download wallpapers"</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>I pressed apply, but it didn't give me a "Success" popup.</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>My walpaper(s) doesn't show up in collections.</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>Where do I find wallpapers?</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>"The folder is improperly set up."</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
        ...
        <div className='pt-7 max-w-[90vw] md:w-[80vw]'>
          <FadeContent blur delay={0.6} duration={0.7} className='bg-[#1c398e]/25 backdrop-blur-[1.8px] w-full p-5 rounded-b-3xl border-[#1c398e]/25 border-4 border-solid'>
            <FadeContent blur delay={0.7} duration={0.7} className='pb-5 text-2xl font-bold'>"Your app hash is incorrect."</FadeContent>
            <FadeContent blur delay={0.8} duration={0.7} className='text-xl'>
